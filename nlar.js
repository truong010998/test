...
app.controller('myController', function($scope) {
	$scope.abm = "About Me";
	$scope.updateInfo = "Updated 5 minuted ago";
	$scope.verify = "Verify";
	$scope.des = "Description about me !";
	$scope.cv = "Công việc";
	$scope.job1 = "IT Help desk";
	$scope.job2 = "Super CuLy";
	$scope.contact = "Thông tin liên lạc";
	$scope.contact1 = "phuoctruong541@gmail.com";
	$scope.contact2 = "fb.com/phuoctruong541";
	...
	$scope.modal4 = "Email";
	$scope.modal5 = "Sms";
	$scope.linkfb = "https://www.facebook.com/phuoctruong541/";
	$scope.linkzl = "http://zaloapp.com/qr/p/890l43pbz5xk";
	$scope.linksc = "";
	$scope.linkgm = "phuoctruong541@gmail";
	$scope.phonenumber = "0935273541 - MobiPhone";
	$scope.email = "phuoctruong541@gmail";
